...
@section('content')
    ...
    <div class="container mt-5">
		<div class="row">
            <div class="col">
                <h1 class="f-green f-24 f-bold">Edit Profile</h1>
                <form method="POST" class="mt-5" action="/edit-profile/{{$user->id}}">
                    @method('PUT')
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="buttons">
                        <button type="submit" class="btn btn-primary mt-3 me-2 rounded-btn">Update</button>
                        <a href="{{ url()->previous() }}" class="btn btn-outline-primary mt-3 me-2 rounded-btn">Kembali</a>
                        <button type="button" class="btn btn-danger mt-3 rounded-btn" data-bs-toggle="modal" data-bs-target="#logout">Logout</button>
                    </div>
                </form>
            </div>
        </div>

...
<head>
    ...
    <title>Register | Kost in Lombok</title>
    ...
    <div class="box rounded-3">
        ...
        <div class="form-in mt-3">
            <div class="title text-center">
                <h3 class="f-18 f-medium f-grey">Daftar</h3>
            </div>
            <form action="/register" method="POST" class="mt-4">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" id="password" placeholder="Masukkan password anda" value="{{ old('password') }}">
                    <div class="invalid-feedback"> @error('password') {{ $message }} @enderror</div>
                </div>
                <div class="form-check mb-3">
                    <input class="form-check-input" type="checkbox" value="as-owner" id="flexCheckDefault" name="check-owner">
                    <label class="form-check-label" for="flexCheckDefault">
                        Register sebagai Owner Kost
                    </label>
                </div>
                <div class="action mt-4">
                    <button type="submit" class="btn btn-primary w-100">Register</button>
                    <p class="mt-2 text-center">Sudah punya akun ? <a href="/login" class="f-green">Login</a></p>
                </div>
            </form>
        </div>
    </div>

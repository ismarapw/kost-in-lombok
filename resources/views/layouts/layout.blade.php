...
<body style="padding-bottom: 100px">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid container">
            <a class="navbar-brand d-flex" href="{{ (Auth::user()->is_owner == true)?'/owner':'/' }}">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item me-3">
                        <a class="nav-link f-medium {{ ($title == 'Home' || $title == 'Owner')?'nav-active': '' }}" href="/">Home</a>
                    </li>
                    @if(Auth::user()->is_owner == false)
                    <li class="nav-item me-3">
                        <a class="nav-link f-medium {{ ($title == 'Kost Favorit')?'nav-active': '' }}"" href="/favorit">Favorit</a>
                    </li>
                    @endif
                    <li class="nav-item me-3}">
                        <a class="nav-link f-medium {{ ($title == 'Edit Profile')?'nav-active': '' }}" href="/edit-profile/{{Auth::user()->id}}">Profile</a>
                    </li>
                </ul>
            </div>
        </div>
